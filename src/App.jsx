...
// --- VISTA MATRÍCULA (CORREGIDA: TECHOPTIONS DEFINIDO) ---
function MatriculaView({ user }) {
  ...
  // --- LISTAS PARA SELECTORES (AQUÍ ESTABA EL ERROR ANTES) ---
  const staffOptions = (usersList||[]).filter(u => ['Docente', 'Auxiliar/Preceptor', 'Equipo Técnico', 'Profes Especiales'].includes(u.role));
  const techOptions = (usersList||[]).filter(u => u.role === 'Equipo Técnico'); // ¡Agregado!
