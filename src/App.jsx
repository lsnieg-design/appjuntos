...
function ResourcesView({ resources, canEdit }) {
    ...
    try {
      ...
      const canvas = await html2canvas(element, { 
        ...
        onclone: (clonedDoc) => {
          ...
          if (txt) txt.style.wordSpacing = 'normal';
        }
      });
  ...
  return (
    <div className="space-y-4 pb-10 px-2">
      ...
      {showNotaModal && (
        <div className="fixed inset-0 bg-black/95 z-[300] flex items-center justify-center backdrop-blur-md" onClick={() => setShowNotaModal(false)}>
          <div className="bg-white rounded-t-[40px] md:rounded-[40px] w-full max-w-7xl flex flex-col h-[100dvh] md:h-[90vh] overflow-hidden relative" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white z-10">
              <h3 className="text-lg font-black text-violet-900 uppercase italic">Editor</h3>
            ...
            <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
              <div className="flex-1 overflow-y-auto p-6 md:p-10 space-y-6 lg:border-r border-gray-50 custom-scrollbar">
                ...
                <div className="space-y-4">
                  ...
                  <textarea value={notaData.body} onChange={e => setNotaData({...notaData, body: e.target.value})} placeholder="Mensaje..." className="w-full p-4 bg-gray-50 rounded-[30px] outline-none text-sm min-h-[200px] lg:h-[300px] resize-none" />
                </div>
              </div>
