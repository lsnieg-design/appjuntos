...
export function InformesView({ user, db, appId }) {
  ...
  const formatearTextoImpresion = (idIndicador, indiceOpcion, respuestaCorta, firstNameRaw) => {
    ...
    // Pégalo justo debajo de donde termina formatearTextoImpresion...

  const generarHTMLImpresion = (student, report) => {
      const nivel = student?.level || 'Inicial';
      ...
      indicadores.forEach(c => {
          ...
          let textoDescriptivo = optionIndex !== -1 ? formatearTextoImpresion(c.id, optionIndex, answer, student?.firstName) : answer;
      ...
      const obs1HTML = report.obsCuatrimestre1 ? `
      ...
      const obs2HTML = report.obsCuatrimestre2 ? `
      ...
      <div class="pagina w-full bg-white text-black font-sans pb-4">
          ...
          <div class="border border-violet-200 rounded-xl p-5 mb-6 bg-white shadow-sm" style="break-inside: avoid;">
              ...
              <div class="grid grid-cols-2 gap-y-3 gap-x-6 text-xs">
                  ...
                  <p><strong class="font-black text-gray-900">Docente a cargo:</strong> <span class="text-gray-700">${student.teacher || student.docente || '....................................'}</span></p>
                  <p><strong class="font-black text-gray-900">Auxiliar/Preceptora:</strong> <span class="text-gray-700">${student.auxiliary || student.auxiliar || student.preceptora || '....................................'}</span></p>
...
const DICCIONARIO = {
  ...
  rutinas: [
    ...
    `Nombre se desenvuelve de forma totalmente autónoma y segura en la ejecución de sus rutinas escolares y pautas de cuidado personal. Gestiona de manera independiente sus tiempos, tareas y necesidades durante la jornada, sin requerir mediación del equipo de apoyo y supervisión. Hace todo solo/a sin que tengamos que estar presentes.`
  ],
  organizacion: [
...
return (
  <div className="max-w-4xl mx-auto p-4 pb-20 animate-in fade-in relative">
    ...
    <div className="flex items-center gap-2">
      ...
      {/* BOTÓN IMPRIMIR DIRECTO (SIN DEMORAS) */}
      {report && (
        <button 
          onClick={() => {
              let contenedor = document.getElementById('impresion-masiva');
              ...
              // Armamos la hoja al instante y disparamos la impresión
